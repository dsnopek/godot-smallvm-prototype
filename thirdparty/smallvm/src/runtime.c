...
// delay() is provided by the embedding host (e.g. embed_platform.c). Forward
// declaration only; the signature matches the Arduino API's declaration that
// appears unconditionally further down in this file.
